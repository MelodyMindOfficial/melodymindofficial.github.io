...
//           </div>
//           {footerList.map((list) => (
//             <div className="footerColumn" key={list.title}>
//               <h3 className="footerTitle">{list.title}</h3>
//               <ul>
//                 {list.list.map((item) => (
...
//             Copyright © 2024 MelodyMind Inc. - интернет-магазин по продаже
//             музыкальных композиций | Made with &hearts; by MickhOse Zitrop
//           </h2>
//         </section>
//       </div>
//     </footer>
